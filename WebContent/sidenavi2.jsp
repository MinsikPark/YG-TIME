...
function memberinvite(projectNum1) {
	...
	var inviteUserId1 = $("#userId").val(); //session ID로 바꿔라
...
function memberList(projectNum2) {
	
		var sessionpnum = $('#gg').serialize();  
		...
		<ul class="dropdown-menu" style="width: 300px;">
			<li><div class="input-group">
					<div class="form-group">
			   			...
			   			<input type="hidden" id="userId" value="jin@naver.com"> 
					</div>
					<span class="input-group-btn">
						<button class="btn btn-default" type="button">
							<span class="glyphicon glyphicon-search"  onclick="memberinvite(67)"></span>
						</button>
					</span>
				</div>
			</li>
